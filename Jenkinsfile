...
simple_pipeline {
   ...
   script_2 = "aws s3 cp s3://d3b-684194535433-us-east-1-service-secrets/d3b-flywheel-routine-empty-containers/app.secrets ."
   script_3 = "chmod +x ./app.secrets"
   script_4 = "sh ./app.secrets"
   script_5 = "python3 fw_delete_empty_containers_DataView.py"
}
